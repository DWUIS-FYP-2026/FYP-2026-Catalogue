/*
  ...
  -------------------------------------------------------------
  To publish a live project resource, add the URL to any of:
  proposalUrl, githubUrl, trelloUrl, workspaceUrl.
  Leave a field as an empty string until the student has supplied
  a valid share link. Do not add passwords or private credentials.
*/
window.PROJECTS = [
  {
    id: "alex-kaka",
