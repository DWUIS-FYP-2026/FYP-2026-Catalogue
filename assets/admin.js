(() => {
  ...
  async function saveCurrentRecord(event) {
    ...
    try {
      ...
      notice(formMessage, "Record committed to GitHub. GitHub Pages will publish the public register after the deployment completes.", "success");
    } catch (error) {
  ...
  function disconnect() {
    ...
    clearForm();
    notice(connectMessage, "Disconnected. The GitHub access token has been removed from this browser tab.", "success");
  }
